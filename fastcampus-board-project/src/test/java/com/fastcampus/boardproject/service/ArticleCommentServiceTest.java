...
class ArticleCommentServiceTest {
    ...
    void givenArticleId_whenSearchingArticleComments_thenReturnsArticleComments() {
        // Given
        Long articleId = 1L;
        UserAccount userAccount = UserAccount.of("hooney", "{noop}hooney1108", "Hooney", "hooney@mail.com", "I am Hooney.");
    ...
    void givenArticleCommentInfo_whenSavingArticleComment_thenSavesArticleComment() {
        ...
        // When
        sut.saveArticleComment(ArticleCommentDto.of(LocalDateTime.now(), "Hooney", LocalDateTime.now(), "Uno", "comment"));
